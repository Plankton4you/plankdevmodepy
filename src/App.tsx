...
import { Menu, X, Download, Search, Code2, FileCode, Terminal, Coffee, Gem } from 'lucide-react';
...
function App() {
  ...
  const products = [
    ...
    { name: 'APK DDOS', price: 'Contact for pricing' },
    { name: 'FILE RANSOM', price: 'Contact for pricing' },
    { name: 'MURBUG', price: 'Contact for pricing' },
